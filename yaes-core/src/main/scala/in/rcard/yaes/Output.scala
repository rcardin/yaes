...
/** A capability trait representing the effect of console output operations.
  *
  * This trait defines a capability for performing console output operations in a controlled manner.
  * Following the capability-passing style pattern, programs requiring output operations must receive
  * an instance of `Output` through context parameters.
  */
...
object Output {
  ...
  /** Lifts a block of code into the Output effect.
    *
    * @param block The code block to be lifted into the Output effect
    * @param out The Output capability provided through context parameters
    * @return The block with the Output capability
    */
  ...
  /** Prints a line of `text` to the console.
    *
    * @param text The text to print
    * @param console The Output capability provided through context parameters
    */
  ...
  /** Runs a block of code that requires Output capability by providing a concrete implementation.
    *
    * This method handles the Output effect by supplying the implementation that directly
    * interfaces with the system console.
    *
    * @param block The code block requiring Output capability
