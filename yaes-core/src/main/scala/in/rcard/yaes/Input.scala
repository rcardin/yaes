...
/** Companion object for the Input capability, providing utility methods and handlers.
  *
  * This object contains methods to run Input operations and a default unsafe implementation
  * that directly interacts with the console.
  *
  * Example usage:
  * {{{
...
object Input {
  ...
  /** Lifts a block of code into the Input effect.
    *
    * @param block The code block to be lifted into the Input effect
    * @param in The Input capability provided through context parameters
    * @return The block with the Input capability
    */
  def apply[A](block: => A)(using in: Input): A = block

  /** Reads a line of input from the console.
    *
    * @param input The Input capability provided through context parameters
  ...
  /** Runs a program that requires Input capability.
    *
    * This method handles the Input effect by supplying the implementation that directly
    ...
    * }}}
    *
    * @param block The code block to be run with the Input capability
