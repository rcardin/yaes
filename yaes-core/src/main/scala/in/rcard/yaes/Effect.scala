...
/**
 * Represents an effect. An Effect is an unpredictable interaction, usually with an external system.
 */
trait Eff
class Yaes[+F <: Eff](val unsafe: F)

object Yaes {

  extension [F <: Eff, A](eff: Yaes[F] ?=> A) {
